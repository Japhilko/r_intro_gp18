...
#' 
#' 
#' - Die Koeffizienten können nicht so einfach wie "die Kinder im Haushalt in der Altersgruppe 0" interpretiert werden. 
#' Wir müssen den inversen Logit verwenden, um etwas auszusagen.
#' 
#' Werte für die Log-odds von `r sum_glm1$coefficients[1,1]`  sind das Gleiche, wie die Wahrscheinlichkeit: 
...
#' 
#' Wir können die Alterswerte in die Formel einsetzen um die vorhergesagten Log-Odds für unterschiedliches Alter zu bekommen.
#' 
