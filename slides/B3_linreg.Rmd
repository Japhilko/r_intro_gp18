...
- Mit einem kontinuierlichen Moderator (in unserem Fall `disp`) erhält man drei Linien -  Standardabweichung über und unter dem Mittelwert und dem Mittelwert selbst. 
...
- Eine detailliertere Erklärung finden Sie in der  [**`Interplot`**](https://cran.r-project.org/web/packages/interplot/vignettes/interplot-vignette.html) Vignette
