...
## B1A Exercise  - enhance the function

- Extend the function so that it also serves its purpose when the value labels are written out (Item nonresponse, Missing by filter, etc.).
