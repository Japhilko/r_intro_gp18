...
Internet-Suche nach Informationen: Freunde (bbzc024a) und Geschlecht (a11d054a)
...
- Ein einfacher Zwei-Wege-Streudiagramm kann mit der Funktion `plot()` erstellt werden.
...
- Achsenbeschriftung - mit `xlab` und `ylab` definiert.
...
### [**Definition eine `lattice` Graphik**](http://stat.ethz.ch/R-manual/R-devel/library/lattice/html/Lattice.html)
...
## [Interactivität hinzufügen](https://moderndata.plot.ly/interactive-r-visualizations-with-d3-ggplot2-rstudio/)
